...
@Component
export default class InstructionInternetBanking extends Base {

    private get steps() {
        return [
            "ดาวน์โหลด Bill payment",
            `เข้าสู่ เว็บไซต์ชำระเงินของธนาคาร  <a target="_blank" class="instruction-link font-weight-bold text-primary-dark" href="${ this.bank?.url || "" }">คลิกที่นี่</a> `,
            "เลือก จ่ายบิล",
            "ค้นหาบริษัทผู้รับชำระเงิน โดยระบุ รหัสบริษัท เซ็นทรัลพัฒนา จำกัด (มหาชน)",
            "กรอกรหัสหมายเลขใบแจ้งค่าบริการในช่อง Invoice No. (Ref1)",
            "กรอกรหัสหมายเลขอ้างอิงชำระเงิน ในช่อง  Customer ID. (Ref2)",
            "ใส่จำนวนเงิน ตรวจสอบข้อมูล และกดยืนยัน​"
        ]
    }

    private get title() {
        return LanguageUtils.lang("อินเทอร์เน็ตแบงก์กิ้ง", "Internet banking")
    }
